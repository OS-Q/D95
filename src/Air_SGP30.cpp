 ...
 */
boolean Air_SGP30::begin(TwoWire *theWire) {
 ...
 *            wrong!
 */
boolean Air_SGP30::IAQinit(void) {
  uint8_t command[2];
  command[0] = 0x20;
  command[1] = 0x03;
 ...
 *          wrong!
 */
boolean Air_SGP30::IAQmeasure(void) {
  uint8_t command[2];
  command[0] = 0x20;
  command[1] = 0x08;
  uint16_t reply[2];
  ...
  */
 boolean Air_SGP30::IAQmeasureRaw(void) {
   uint8_t command[2];
   command[0] = 0x20;
   command[1] = 0x50;
   uint16_t reply[2];
 ...
 *           wrong!
 */
boolean Air_SGP30::getIAQBaseline(uint16_t *eco2_base,
                                       uint16_t *tvoc_base) {
  uint8_t command[2];
  command[0] = 0x20;
  command[1] = 0x15;
 ...
 *          wrong!
 */
boolean Air_SGP30::setIAQBaseline(uint16_t eco2_base, uint16_t tvoc_base) {
  uint8_t command[8];
  command[0] = 0x20;
  command[1] = 0x1e;
 ...
 *          wrong!
 */
boolean Air_SGP30::setHumidity(uint32_t absolute_humidity) {
...
boolean Air_SGP30::readWordFromCommand(uint8_t command[],
...
uint8_t Air_SGP30::generateCRC(uint8_t *data, uint8_t datalen) {
